  ...
  return (
    ...
    <div className="relative overflow-hidden h-[20rem] md:h-[30rem] lg:h-[35rem]"> {/* Adjusted height */}
      ...
      <div className="absolute inset-0 flex items-center justify-center p-10 bg-black bg-opacity-40 mx-auto"> {/* Adjusted class for centering */}
        ...
        >
          <h3 className="text-4xl md:text-4xlxl lg:text-6xl font-bold ">KKN 86 UAJY</h3>
          <p className="text-md md:text-lg lg:text-xl max-w-2xl font-thin text-[#A7CA73]">ꦏꦸꦭꦶꦪꦃꦏꦼꦂꦗꦚꦠ</p>
        </motion.div>
      </div>
      </div>
