...
const Intro = () => {
  ...
  return (
    <div className="relative overflow-hidden h-[10rem] md:h-[20rem] lg:h-[23rem]"> {/* Adjusted height */}
      <Slider {...settings}>
        {images.map((image, index) => (
          <div key={index} className="relative h-[10rem] md:h-[20rem] lg:h-[23rem]"> {/* Adjusted height */}
            <LazyLoadImage
              src={image}
              alt={`Slide ${index + 1}`}
